  ...
  return (
    <div className="empower-page">
      ...
      <div className="empower-tab-content">
        ...
        {/* ✅ FIXED: system prop now passed safely */}
        {activeTab === "scheduler" && (
          <Scheduler
        ...
        {activeTab === "workflow" && (
          <div className="empower-panel">
            <div className="empower-panel__title">Workflow</div>
            <p className="empower-panel__sub">
              Configure approval workflow for Empower.
            </p>
          </div>
        )}
