        ...
        <div className="cr-form-card">
          ...
          <div className="form-row-3">
            <div className="form-field">
              ...
              <input className="field-input" placeholder="e.g. Daily QC Summary" value={formName} onChange={e => setFormName(e.target.value)} />
            </div>
            <div className="form-field">
          ...
          <div className="form-field">
            ...
            <input className="field-input" placeholder="qa@org.io, mgr@org.io..." value={formEmail} onChange={e => setFormEmail(e.target.value)} />
          </div>

          {!formName.trim() && <div className="form-hint">⚠ Report name is required</div>}
